...
- Simplify User Management by integrating Oracle Autonomous Database and Oracle Cloud Identity: https://livelabs.oracle.com/pls/apex/r/dbpm/livelabs/view-workshop?wid=3565
- Tales from the Dark Side: Hacking the Database: https://livelabs.oracle.com/pls/apex/r/dbpm/livelabs/view-workshop?wid=3300
- Authenticating and Authorizing IAM Users for Oracle DBaaS Databases: https://docs.oracle.com/en/database/oracle/oracle-database/23/dbseg/authenticating-and-authorizing-iam-users-oracle-dbaas-databases.html
- Authenticating and Authorizing Microsoft Azure Users for Oracle Databases: https://docs.oracle.com/en/database/oracle/oracle-database/23/dbseg/authenticating-and-authorizing-microsoft-entra-id-azure-ad-users-oracle-databases.html
...
- Managing Security for Definer's Rights and Invoker's Rights: https://docs.oracle.com/en/database/oracle/oracle-database/23/dbseg/managing-security-for-definers-rights-and-invokers-rights.html
- ACCESSIBLE BY clause: https://docs.oracle.com/en/database/oracle/oracle-database/23/lnpls/ACCESSIBLE-BY-clause.html
- GRANT, grant_roles_to_programs: https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/GRANT.html
- ALL_CODE_ROLE_PRIVS view: https://docs.oracle.com/en/database/oracle/oracle-database/23/refrn/ALL_CODE_ROLE_PRIVS.html
